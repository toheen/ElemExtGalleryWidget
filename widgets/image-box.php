<?php
namespace WPToheen_Elementor\Widgets;
...
class Widget_WPTips_Image_Box extends Widget_Base
{
    ...
    {
        return __('WP Tips Image Box', 'elementor-toheen-gallery-widget');
    }
    ...
    protected function _register_controls()
    {
        $this->start_controls_section(
            'section_image',
            [
                'label' => __('WP Tips Image Box', 'elementor-toheen-gallery-widget'),
        ...
        $this->add_control(
            'image',
            [
                'label' => __('Choose Image', 'elementor-toheen-gallery-widget'),
        ...
        $this->add_control(
            'title_text',
            [
                'label' => __('Title, Subtitle & Description', 'elementor-toheen-gallery-widget'),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
                'default' => __('This is the heading', 'elementor-toheen-gallery-widget'),
                'placeholder' => __('Enter your title', 'elementor-toheen-gallery-widget'),
                'label_block' => true,
            ]
        ); 
        ...
        $this->add_control(
            'description_text',
            [
                'label' => __('Content', 'elementor-toheen-gallery-widget'),
                'type' => Controls_Manager::TEXTAREA,
                'dynamic' => [
                    'active' => true,
                ],
                'default' => __('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'elementor-toheen-gallery-widget'),
                'placeholder' => __('Enter your description', 'elementor-toheen-gallery-widget'),
                'separator' => 'none',
                'rows' => 10,
                'show_label' => false,
            ]
        ...
        $this->add_control(
            'link',
            [
                'label' => __('Link', 'elementor-toheen-gallery-widget'),
                'type' => Controls_Manager::URL,
                'dynamic' => [
                    'active' => true,
                ],
                'placeholder' => __('https://your-link.com', 'elementor-toheen-gallery-widget'),
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'position',
            [
                'label' => __('Image Position', 'elementor-toheen-gallery-widget'),
                'type' => Controls_Manager::CHOOSE,
                'default' => 'top',
                'options' => [
                    'left' => [
                        'title' => __('Left', 'elementor-toheen-gallery-widget'),
                        'icon' => 'eicon-h-align-left',
                    ],
                    'top' => [
                        'title' => __('Top', 'elementor-toheen-gallery-widget'),
                        'icon' => 'eicon-v-align-top',
                    ],
                    'right' => [
                        'title' => __('Right', 'elementor-toheen-gallery-widget'),
        ...
        $this->add_control(
            'title_size',
            [
                'label' => __('Title HTML Tag', 'elementor-toheen-gallery-widget'),
        ...
        $this->add_control(
            'view',
            [
                'label' => __('View', 'elementor-toheen-gallery-widget'),
        ...
        $this->start_controls_section(
            'section_style_image',
            [
                'label' => __('Image', 'elementor-toheen-gallery-widget'),
        ...
        $this->add_responsive_control(
            'image_space',
            [
                'label' => __('Spacing', 'elementor-toheen-gallery-widget'),
        ...
        $this->add_responsive_control(
            'image_size',
            [
                'label' => __('Width', 'elementor-toheen-gallery-widget') . ' (%)',
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 30,
                    'unit' => '%',
        ...
        $this->add_control(
            'hover_animation',
            [
                'label' => __('Hover Animation', 'elementor-toheen-gallery-widget'),
        ...
        $this->start_controls_tab('normal',
            [
                'label' => __('Normal', 'elementor-toheen-gallery-widget'),
            ]
        );
        ...
        $this->add_control(
            'image_opacity',
            [
                'label' => __('Opacity', 'elementor-toheen-gallery-widget'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 1,
        ...
        $this->add_control(
            ...
            [
                'label' => __('Transition Duration', 'elementor-toheen-gallery-widget'),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 0.3,
                ],
        ...
        $this->start_controls_tab('hover',
            [
                'label' => __('Hover', 'elementor-toheen-gallery-widget'),
            ]
        );
        ...
        $this->add_responsive_control(
            'text_align',
            [
                'label' => __('Alignment', 'elementor-toheen-gallery-widget'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => __('Left', 'elementor-toheen-gallery-widget'),
                    ...
                    'center' => [
                        'title' => __('Center', 'elementor-toheen-gallery-widget'),
                    ...
                    'justify' => [
                        'title' => __('Justified', 'elementor-toheen-gallery-widget'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Vertical Alignment', 'elementor-toheen-gallery-widget'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'top' => __('Top', 'elementor-toheen-gallery-widget'),
                    'middle' => __('Middle', 'elementor-toheen-gallery-widget'),
                    'bottom' => __('Bottom', 'elementor-toheen-gallery-widget'),
                ],
                'default' => 'top',
        ...
        $this->add_control(
            'heading_title',
            [
                'label' => __('Title', 'elementor-toheen-gallery-widget'),
        ...
        $this->add_control(
            'title_color',
            [
                'label' => __('Color', 'elementor-toheen-gallery-widget'),
        ...
        $this->add_control(
            'heading_description',
            [
                'label' => __('Description', 'elementor-toheen-gallery-widget'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
